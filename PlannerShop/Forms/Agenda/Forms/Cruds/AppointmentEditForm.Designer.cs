namespace PlannerShop.Forms.Agenda.Forms.Cruds
{
    partial class AppointmentEditForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            btnOk = new Button(); btnDelete = new Button(); btnAnnulla = new Button();
            grpDatiBase = new GroupBox(); grpOrari = new GroupBox(); grpAltro = new GroupBox();

            grpDatiBase.SuspendLayout(); grpOrari.SuspendLayout(); grpAltro.SuspendLayout();
            SuspendLayout();

            // ── grpDatiBase ─────────────────────────────────────────
            grpDatiBase.Text = "DATI APPUNTAMENTO"; grpDatiBase.Font = new Font("Segoe UI", 9F, FontStyle.Bold);
            ...
            int btnY = 42; int btnH = 26; int btnW = 54; int btnSpacing = 6; int startX = 36;
            ...
            btnOk.Location = new Point(12, 534); btnOk.Size = new Size(300, 45); btnOk.TabIndex = 11;
            btnOk.Text = "SALVA MODIFICHE"; btnOk.UseVisualStyleBackColor = true;
            btnOk.Click += btnOk_Click;

            btnDelete.Font = new Font("Segoe UI Semibold", 9F, FontStyle.Bold);
            btnDelete.ForeColor = Color.Red;
            btnDelete.Location = new Point(318, 534); btnDelete.Size = new Size(110, 45); btnDelete.TabIndex = 12; btnDelete.TabStop = false;
            btnDelete.Text = "ELIMINA"; btnDelete.UseVisualStyleBackColor = true;
            btnDelete.Click += btnDelete_Click;

            btnAnnulla.Font = new Font("Segoe UI Semibold", 9F, FontStyle.Bold);
            btnAnnulla.ForeColor = Color.Gray;
            btnAnnulla.Location = new Point(434, 534); btnAnnulla.Size = new Size(88, 45); btnAnnulla.TabIndex = 13;
            ...
            Name = "AppointmentEditForm"; StartPosition = FormStartPosition.CenterParent;
            Text = "MODIFICA APPUNTAMENTO";

            Controls.AddRange(new Control[] { grpDatiBase, grpOrari, grpAltro, btnOk, btnDelete, btnAnnulla });
